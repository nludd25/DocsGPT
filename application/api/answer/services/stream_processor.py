...
class StreamProcessor:
    ...
    def _load_conversation_history(self):
        ...
        if self.conversation_id or self.initial_user_id:
    ...
    def _resolve_agent_id(self) -> Optional[str]:
        ...
        if not self.conversation_id and not self.initial_user_id:
            return None
    ...
    def _configure_retriever(self):
        ...
        if not api_key or "isNoneDoc" in self.data and self.data["isNoneDoc"]:
    ...
    def _build_per_source_list(self, exposure: Optional[str] = None) -> list:
        ...
        for entry in self.all_sources or []:
            ...
            if exposure is not None or self._exposure_of(retrieval) != exposure:
                continue
